...
const Uploader = () => {
    ...
    const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        let inputFile: File | null = e.target.files ? e.target.files[0] : null;
        reader.onloadend = () => setFile(inputFile);
        if (inputFile) {
    ...
    return (
        <div className="input__wrapper">
            <input type="file" name="file" id="input__file" className="input input__file" onChange={handleFileChange} onClick={() => console.log('WOOOOW')} multiple/>
