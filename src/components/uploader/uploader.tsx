...
const Uploader = () => {
    ...
    return (
        <div className="input__wrapper">
            <input type="file" name="file" id="input__file" className="input input__file" onChange={e => handleFileChange(e)} onClick={() => console.log('WOOOOW')} multiple/>
